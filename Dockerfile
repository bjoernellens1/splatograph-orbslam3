...
RUN apt-get update && apt-get install -y --no-install-recommends       build-essential cmake git ca-certificates pkg-config       libopencv-dev libeigen3-dev libboost-system-dev libboost-serialization-dev libssl-dev       libgl1-mesa-dev libglew-dev libxkbcommon-dev libwayland-dev wayland-protocols       libegl1-mesa-dev libc++-dev libepoxy-dev libjpeg-dev libpng-dev libtiff-dev       python3-colcon-common-extensions python3-natsort python3-wheel       ros-jazzy-ament-cmake ros-jazzy-ament-cmake-python ros-jazzy-cv-bridge       ros-jazzy-diagnostic-msgs ros-jazzy-geometry-msgs ros-jazzy-image-transport ros-jazzy-message-filters ros-jazzy-sensor-msgs ros-jazzy-std-msgs     && rm -rf /var/lib/apt/lists/*
...
ENV ROS_DISTRO=jazzy     DEBIAN_FRONTEND=noninteractive     RMW_IMPLEMENTATION=rmw_zenoh_cpp
RUN apt-get update && apt-get install -y --no-install-recommends       libopencv-dev libboost-system1.83.0 libboost-serialization1.83.0 libssl3       libgl1 libglew2.2 libepoxy0 libwayland-egl1 libwayland-cursor0 python3-natsort       ros-jazzy-cv-bridge ros-jazzy-diagnostic-msgs ros-jazzy-image-transport ros-jazzy-rmw-zenoh-cpp ros-jazzy-sensor-msgs ros-jazzy-std-msgs     && rm -rf /var/lib/apt/lists/*
